...
export interface PricingService {
  ...
  quoteOnly?: boolean
  /** Service accepts on-request customization details from the client. */
  configurable?: boolean
  /** Extra pricing clarification shown under the price (e.g. print not included). */
  priceNote?: string
}
...
export const pricingServices: PricingService[] = [
  ...
  { id: 9, name: "Flyers & Affiches", desc: "Conception pour impression petit format — flyer, affiche, badge, certificat, brochure, book cover.", price: 55, qty: 0, type: "static", advantage: "Des supports imprimés percutants qui attirent l'attention en un regard.", deliveryDays: 2, revisions: 4, revisionDays: 3, exampleImg: socialFlyer },
  { id: 10, name: "Affiche Réseaux Sociaux", desc: "Visuels optimisés pour vos publications — flyers, affiches et miniatures YouTube.", price: 55, qty: 0, type: "static", advantage: "Une présence visuelle cohérente et professionnelle sur tous vos réseaux.", deliveryDays: 2, revisions: 4, revisionDays: 3, exampleImg: socialFlyer },
