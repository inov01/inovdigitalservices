...
import {
  loadReminders, saveReminders, newReminderId, kindLabel, downloadICS,
  ensureNotificationPermission, fireNotification,
...
function Dashboard({ email, onSignOut }: { email: string; onSignOut: () => void }) {
  ...
  const navItems: { key: Tab; label: string; icon: React.ReactNode; count?: number }[] = [
    ...
    { key: "procedures", label: "Procédures services", icon: <ClipboardList size={18} /> },
